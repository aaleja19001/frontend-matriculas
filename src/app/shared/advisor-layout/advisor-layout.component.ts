    ...
    <div style="min-height: 100vh; background-color: #F8FAFC;">
      ...
      <nav style="background: #FFFFFF; border-bottom: 1px solid #E2E8F0; padding: 0 2rem; height: 64px; display: flex; align-items: center; justify-content: space-between; position: sticky; top: 0; z-index: 40;">
        ...
        <div style="display: flex; align-items: center; gap: 0.5rem;">
          <div style="width: 2rem; height: 2rem; background-color: #10B981; border-radius: 0.5rem; display: flex; align-items: center; justify-content: center;">
          ...
          <span style="font-size: 0.875rem; font-weight: 700; color: #0F172A;">Matricula<span style="color: #10B981;">+</span> Asesor</span>
        </div>

        <div style="display: flex; align-items: center; gap: 1.5rem;">
          <a routerLink="/advisor/dashboard" routerLinkActive="active-nav"
             style="font-size: 0.875rem; font-weight: 500; color: #64748B; text-decoration: none;">
            Mis Asesorías
          </a>
          <a routerLink="/advisor/profile" routerLinkActive="active-nav"
             style="font-size: 0.875rem; font-weight: 500; color: #64748B; text-decoration: none;">
            Mi Perfil
          </a>
          <div style="display: flex; align-items: center; gap: 0.75rem; padding-left: 1rem; border-left: 1px solid #E2E8F0;">
            <div style="width: 2rem; height: 2rem; background-color: #ECFDF5; border-radius: 9999px; display: flex; align-items: center; justify-content: center;">
